...
class NotificationFraction extends StatelessWidget {
  NotificationFraction({Key? key, required this.scrollController}) : super(key: key);
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Txt(
                  text: StringLib.notificationTxt,
